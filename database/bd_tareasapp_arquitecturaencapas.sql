...
--
-- Base de datos: `bd_tareasapp_arquitecturaencapas`
--
...
CREATE TABLE `tareas` (
  ...
  `estado` set('pendiente','en_proceso','completo') NOT NULL DEFAULT 'pendiente',
...
--
ALTER TABLE `tareas`
  ADD CONSTRAINT `User_Task_FK` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
